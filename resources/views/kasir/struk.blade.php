...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .struk-header { background:#2c1810; padding:24px 20px 20px; text-align:center; }
        .struk-icon { font-size:32px; margin-bottom:6px; }
        .struk-name { font-family:'Playfair Display',serif; font-size:20px; font-weight:800; color:#c9a227; letter-spacing:2px; }
        ...
        .info-row { display:flex; justify-content:space-between; align-items:center; font-size:12.5px; color:#7a6552; padding:3px 0; }
        ...
        .item { display:flex; justify-content:space-between; align-items:flex-start; padding:7px 0; border-bottom:1px solid #f5ece0; }
        ...
        .total-row { display:flex; justify-content:space-between; font-size:13px; color:#7a6552; padding:3px 0; }
        .total-final {
        ...
        .bayar-box { background:#faf5ee; border-radius:10px; padding:12px 14px; margin-top:14px; border:1.5px solid #e0d5c5; }
        .bayar-row { display:flex; justify-content:space-between; font-size:13px; color:#5a3e2b; padding:2px 0; font-weight:500; }
        .bayar-row.kembalian { color:#1a7a4a; font-weight:800; }

        .struk-footer { background:#faf5ee; border-top:1.5px dashed #e0d5c5; padding:16px 20px; text-align:center; }
        ...
        .btn-actions { display:flex; gap:10px; padding:16px 20px; background:#fff; border-top:1px solid #f0e8d8; }
        .btn-print {
            flex:1; padding:11px;
...
<div class="struk">
    ...
    <div class="struk-body">
        ...
        @if(isset($jumlahBayar) && $jumlahBayar > 0 && ($transaksi->metode ?? 'cash') === 'cash')
        <div class="bayar-box">
        ...
        <div class="bayar-box">
            <div class="bayar-row" style="justify-content:center;color:#1d4ed8;">
                ✅ Pembayaran QRIS Terkonfirmasi
            </div>
        </div>
        @elseif(($transaksi->metode ?? '') === 'debit')
        <div class="bayar-box">
            <div class="bayar-row" style="justify-content:center;color:#6d28d9;">
                ✅ Pembayaran Debit/Kartu Terkonfirmasi
            </div>
        </div>
        @endif
    </div>
